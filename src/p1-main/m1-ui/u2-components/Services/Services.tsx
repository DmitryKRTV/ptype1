...
export const Services = () => {
    ...
    const [toggleModal, setToggleModal] = useState<0 | 1 | 2 | 3>(0);
        ...
        <section className={"services section"} id={"services"}>
            ...
            <div className="services__container container grid">
                <div className="services__content">
                    ...
                    <span className="services__button" onClick={()=>{setToggleModal(1)}}>
                        View More
                ...
                <div className="services__content">
                    ...
                    <span className="services__button" onClick={()=>{setToggleModal(2)}}>
                        View More
                        <i className="uil uil-arrow-right services__button-icon"></i>
                    </span>
                ...
                <div className="services__content">
                    ...
                    <span className="services__button" onClick={()=>{setToggleModal(3)}}>
                        View More
                        <i className="uil uil-arrow-right services__button-icon" ></i>
                    </span>
